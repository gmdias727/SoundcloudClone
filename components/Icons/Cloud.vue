<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 -1 20 20">
        <g fill="currentColor" fillRule="evenodd" clipRule="evenodd">
            <path d="M13 4h-1a4 4 0 0 0-3.874 3H8a4 4 0 1 0 0 8h8a4 4 0 0 0 .899-7.899A4 4 0 0 0 13 4" opacity=".2">
            </path>
            <path
